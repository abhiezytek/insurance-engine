...
public interface IPayoutService
{
    ...
    Task<List<PayoutCaseDto>> GetCases(string? payoutType, string? status, string? inputMode, int page, int pageSize);
    Task<PayoutDashboardDto> GetDashboard();
    Task<List<PayoutBatchDto>> GetBatches(string? payoutType, int page, int pageSize);
